...
l2, b2 = 5, 5
blurred = cv2.blur(gray_img, (5,5))
unsharpened_edges = 2*(gray_img - blurred)
unsharpened_final = gray_img + unsharpened_edges
# cv2.imshow('Unsharpened Edges', unsharpened_edges)
cv2.imshow('Unsharpened', unsharpened_final)
cv2.waitKey(0)
